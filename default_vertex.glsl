...
layout (location = 3) in float attribute_specular;
...
void main()
{
	...
	// Pass the position attribute, color attribute, normal attribute and 
	// specular attribute to the fragment shader.
	...
	specular_attribute = attribute_specular;
